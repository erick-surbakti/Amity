  ...
  return (
    <div className="relative w-full overflow-hidden bg-white selection:bg-black selection:text-white">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <video
          ref={videoRef}
          className="absolute w-full h-full object-cover transition-opacity duration-300 md:object-cover"
          style={{ top: 0, left: 0, opacity: videoOpacity }}
          playsInline
          muted
          loop={false}
        >
      ...
      <div className="relative z-30 bg-rose-50 border-y border-rose-100 py-8">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <a href="tel:911" className="inline-flex items-center gap-3 mt-6 px-10 py-4 bg-rose-600 hover:bg-rose-700 text-white rounded-2xl font-medium transition-all active:scale-95">
